"""T2: sampled Round 6 tool-selection regression."""
...
from experiments.benchmarks.round7_domain_softening.scenarios_v7 import T2_SCENARIOS


ROUND7_DIR = Path(__file__).resolve().parent
ROUND6_DIR = ROUND7_DIR.parent / "round6_full_coverage"
