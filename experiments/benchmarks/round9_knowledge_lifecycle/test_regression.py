"""T2: sampled Round 6 tool-selection regression for lifecycle tools."""
...
from experiments.benchmarks.round9_knowledge_lifecycle.scenarios_v9 import T2_SCENARIOS


ROUND9_DIR = Path(__file__).resolve().parent
ROUND6_DIR = ROUND9_DIR.parent / "round6_full_coverage"
